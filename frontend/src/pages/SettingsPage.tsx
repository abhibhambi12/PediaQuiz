...
const SettingsPage: React.FC = () => {
    ...
    const handleRefreshData = () => {
        ...
        // Invalidate the 'appData' query, which will cause TanStack Query to refetch it.
        queryClient.invalidateQueries({ queryKey: ['appData'] });
        addToast("Data refresh complete!", "success");
    };

    const handleResetProgress = () => {
        // This is a complex action that would involve many Firestore writes.
        // It's best handled by a dedicated Cloud Function for atomicity.
