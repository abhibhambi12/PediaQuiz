...
import {
  ...
  Navigate,
  Outlet,
  Link as RouterLink, // Renamed to avoid conflict
  ...
  return (
    <Suspense fallback={<Loader message="Loading page..." />}>
      <Routes>
        ...
        {/* Redirect from auth path if user is already logged in */}
        {/* Removed as it's handled by the element prop on the /auth route */}
