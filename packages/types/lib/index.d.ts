...
export type UploadStatus = 'processing_ocr' | 'pending_planning' | 'pending_generation' | 'generating_content' | 'generation_failed_partially' | 'pending_assignment' | 'completed' | 'error' | 'archived';
