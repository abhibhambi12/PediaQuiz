// --- CORRECTED FILE: workspaces/frontend/src/utils/validation.ts ---

import { z } from "zod";
import { HttpsError } from "firebase-functions/v2/https";
// FIX: Use relative import for types to bypass potential module resolution issues
import type { ToggleBookmarkCallableData, DeleteContentItemCallableData, QuizResult } from '../../types/src';
