  ...
  theme: {
    extend: {
      colors: {
        ...
        // Renamed 'secondary' to distinguish from tailwind's default indigo if any conflict or just for clarity.
        // If you intended these to be 'indigo', you can revert the name, but changed for consistency with how other colors are defined.
